...
import { useGetSellerOrdersQuery } from '@/store/apis/orderApi';
...
export default function SellerOrdersList() {
  ...
  const { data, isLoading, isFetching, isError, refetch } = useGetSellerOrdersQuery({
    page,
    limit: 10,
    // status: activeTab,
  });
